...
/**
 * 作者：wxw on 2016/11/12 10:43
 * 邮箱：1069289509@qq.com
 */
public class LogUtilWly {
    ...
    private static final String FLAG= Constants.LOG_FLAG_WLY;
    private static final String FLAG_END= Constants.FLAG_END_WLY;
